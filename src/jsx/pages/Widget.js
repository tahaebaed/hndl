...
const Widget = () => {
  return (
    <Fragment>
      {/* <Ext /> */}
      <PageTitle activeMenu='Statistics' motherMenu='Widget' pageContent='Statistics' />
      <div className='row'>
                ...
                <ul className='timeline'>
                  ...
                  <li>
                    <div className='timeline-panel'>
                      ...
                      <Dropdown className='dropdown'>
                        <Dropdown.Toggle variant=' light' className=' btn-info i-false p-0 sharp'>
                          <svg width='18px' height='18px' viewBox='0 0 24 24' version='1.1'>
                            <g stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
                              <rect x='0' y='0' width='24' height='24' />
                              <circle fill='#000000' cx='5' cy='12' r='2' />
                  ...
                  <li>
                    <div className='timeline-panel'>
                      ...
                      <Dropdown className='dropdown'>
                        <Dropdown.Toggle variant=' light' className='btn-danger i-false p-0 sharp'>
                          <svg width='18px' height='18px' viewBox='0 0 24 24' version='1.1'>
                            <g stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
                              <rect x='0' y='0' width='24' height='24' />
                              <circle fill='#000000' cx='5' cy='12' r='2' />
                ...
                <ul className='timeline'>
                  ...
                  <li>
                    <div className='timeline-panel'>
                      ...
                      <Dropdown className='dropdown'>
                        <Dropdown.Toggle variant=' light' className='btn-success i-false p-0 sharp'>
                          <svg width='18px' height='18px' viewBox='0 0 24 24' version='1.1'>
                            <g stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
                              <rect x='0' y='0' width='24' height='24' />
                              <circle fill='#000000' cx='5' cy='12' r='2' />
