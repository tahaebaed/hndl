...
const SingleJob = (props) => {
  const { subTitle, title, icon, lowRate, highRate, description, locationPlace, locationCountry } =
    props.jobData;
  return (
      ...
      <div className='card shadow_1'>
        <div className='card-body'>
          ...
          <div className='d-flex align-items-center mt-4'>
            <Link to='search-job' className='btn btn-primary light btn-rounded mr-auto'>
              REMOTE
            </Link>
