                  ...
                  <div className='card-action card-tabs mt-3 mt-3 mt-lg-0'>
                    <Tab.Container defaultActiveKey={tabData[0].name.toLowerCase()}>
                      ...
                      <Tab.Content className=''>
                        {tabData.map((data, i) => (
                          <Tab.Pane eventKey={data.name.toLowerCase()} key={i}></Tab.Pane>
                        ))}
                      </Tab.Content>
                    </Tab.Container>
                  </div>
                      ...
                      <div className='media align-items-center'>
                        <Link to={'/ecom-product-detail'}>
                          <img
                            ...
                            src={require('./../../../../images/card/pic4.jpg').default}
                            alt=''
                            width='105'
                          />
                        </Link>
                        <div className='media-body'>
                          ...
                          <Link to={'#'} className='text-primary fs-14 d-flex align-items-center'>
                            <i className='fa fa-heart fs-20 mr-2' aria-hidden='true'></i>{' '}
                    ...
                    <div className='col-xl-5 col-lg-5 col-sm-8 col-12 mb-3 mb-lg-0'>
                      <div className='media align-items-center'>
                        <Link to={'/ecom-product-detail'}>
                          <img
                            className='rounded mr-3'
                            src={require('./../../../../images/card/pic2.jpg').default}
                            alt=''
                            width='105'
                          />
                        </Link>
                  ...
                  <div className='media align-items-center mb-4'>
                    <Link to={'/app-profile'}>
                      <img
                        ...
                        src={require('../../../../images/profile/5.jpg').default}
                        width='70'
                        alt=''
                      />
                    </Link>
                    <div className='media-body'>
                      ...
                      <small className='text-primary mb-0'>
                        <strong className='font-w600'>651</strong> Times order
                      </small>
                    </div>
                  </div>
                  <div className='media align-items-center mb-4'>
                    ...
                    <div className='media-body'>
                      ...
                      <small className='text-primary mb-0'>
                        <strong className='font-w600'>356</strong> Times order
                      </small>
                    </div>
                  </div>
                  <div className='media align-items-center mb-4'>
                    <Link to={'/app-profile'}>
                      <img
                        className='mr-3 rounded'
                        src={require('../../../../images/profile/7.jpg').default}
                        width='70'
                        alt=''
                      />
                    </Link>
                    <div className='media-body'>
                      ...
                      <small className='text-primary mb-0'>
                        <strong className='font-w600'>125</strong> Times order
                      </small>
                    </div>
                  </div>
                  <div className='media align-items-center'>
                    <Link to={'/app-profile'}>
                      <img
                        className='mr-3 rounded'
                        src={require('../../../../images/profile/10.jpg').default}
                        width='70'
                        alt=''
                      />
                    </Link>
                    <div className='media-body'>
                      ...
                      <small className='text-primary mb-0'>
                        <strong className='font-w600'>78</strong> Times order
                      </small>
                    </div>
                  </div>
                </div>
                        ...
                        <div className='timeline-panel'>
                          <div className='media mr-4'>
                            <Link to={'/ecom-product-detail'}>
                              <img
                                alt=''
                                width='90'
                                src={require('../../../../images/card/pic8.jpg').default}
                              />
                            </Link>
                          ...
                          <div className='media-body'>
                            ...
                            <div className='d-flex justify-content-between align-items-center'>
                              ...
                              <p className='mb-0'>
                                Order <strong className='text-black font-w500'>89x</strong>
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className='timeline-panel'>
                          ...
                          <div className='media-body'>
                            ...
                            <div className='d-flex justify-content-between align-items-center'>
                              ...
                              <p className='mb-0'>
                                Order <strong className='text-black font-w500'>67x</strong>
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className='timeline-panel'>
                          <div className='media mr-4'>
                            <Link to={'/ecom-product-detail'}>
                              <img
                                alt=''
                                width='90'
                                src={require('../../../../images/card/pic9.jpg').default}
                              />
                            </Link>
                          ...
                          <div className='media-body'>
                            ...
                            <div className='d-flex justify-content-between align-items-center'>
                              ...
                              <p className='mb-0'>
                                Order <strong className='text-black font-w500'>59x</strong>
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className='timeline-panel'>
                          ...
                          <div className='media-body'>
                            ...
                            <div className='d-flex justify-content-between align-items-center'>
                              ...
                              <p className='mb-0'>
                                Order <strong className='text-black font-w500'>49x</strong>
                              </p>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className='media mr-4'>
                            <Link to={'/ecom-product-detail'}>
                              <img
                                alt=''
                                width='90'
                                src={require('../../../../images/card/pic10.jpg').default}
                              />
                            </Link>
                ...
                <div className='card-body border-bottom'>
                  <div className='media mb-3'>
                    <Link to={'/ecom-product-detail'}>
                      <img
                        className='rounded'
                        src={require('../../../../images/card/pic11.jpg').default}
                        style={{ width: '100%' }}
                        alt=''
                      />
                    </Link>
                ...
                <div className='card-body border-bottom'>
                  <div className='media mb-3'>
                    <Link to={'/ecom-product-detail'}>
                      <img
                        className='rounded'
                        src={require('../../../../images/card/pic12.jpg').default}
                        style={{ width: '100%' }}
                        alt=''
                      />
                    </Link>
