      ...
      <Fragment>
        <div className='form-head d-flex mb-3 mb-md-5 align-items-start'>
          <div className='mr-auto d-none d-lg-block'>
            ...
            <Link to={'#'} className='mb-0 text-black font-w500'>
              Orders /
            </Link>
            <Link to={'#'} className='mb-0 font-w500'>
              {' '}
              Order Detaills{' '}
            </Link>
          </div>
          <div className='dropdown ml-auto'>
            <div
              className='btn btn-primary btn-rounded dropdown-toggle d-block  px-4'
                ...
                <div className='card'>
                  <div className='card-body'>
                    <div className='full-map-area'>
                      <img
                        src={require('../../../../images/svg/map.svg').default}
                        alt=''
                        style={{ width: '100%' }}
                      />
                      <Link to={'#'}>
                        ...
                        >
                          <path
                            d='M23 8.93333H21V4.41733L13.414 12L21 19.5853V15.0667H23V23H15.0667V21H19.5833L12 13.414L4.41467 21H8.93333V23H1V15.0667H3V19.584L10.586 12L3.00333 4.41467V8.93333H1.00333V1H8.93333V3H4.41733L12 10.586L19.5853 3.00333H15.0667V1.00333H23V8.93333Z'
                            fill='white'
                          ></path>
                        </svg>
                      </Link>
                    ...
                    <div className='row mx-0 align-items-center'>
                      <div className='media align-items-center col-xl-6 col-lg-5 px-0 mb-3 mb-md-0'>
                        <img
                          ...
                          width='100'
                          src={require('../../../../images/profile/5.png').default}
                          alt='DexignZone'
                        />
                              ...
                              <div className='media'>
                                <Link to={'/ecom-product-detail'}>
                                  <img
                                    ...
                                    width='85'
                                    src={require('../../../../images/card/pic5.jpg').default}
                                    alt='DexignZone'
                                  />
                                </Link>
                                <div className='media-body'>
                              ...
                              <div className='media'>
                                <Link to={'/ecom-product-detail'}>
                                  <img
                                    className='mr-3 img-fluid rounded'
                                    width='85'
                                    src={require('../../../../images/card/pic6.jpg').default}
                                    alt='DexignZone'
                                  />
                                </Link>
                                <div className='media-body'>
                              ...
                              <div className='media'>
                                <Link to={'/ecom-product-detail'}>
                                  <img
                                    className='mr-3 img-fluid rounded'
                                    width='85'
                                    src={require('../../../../images/card/pic7.jpg').default}
                                    alt='DexignZone'
                                  />
                                </Link>
                                <div className='media-body'>
                  ...
                  <div className='card-body border-bottom'>
                    <div className='media align-items-center'>
                      <img
                        ...
                        src={require('../../../../images/profile/6.jpg').default}
                        width='90'
                        alt=''
                      />
                      <div className='media-body'>
