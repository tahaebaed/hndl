            ...
            <div className='col-xl-12'>
              <div className='card profile-card'>
                <div className='card-header flex-wrap border-0 pb-0'>
                  <h3 className='fs-24 text-black font-w600 mr-auto mb-2 pr-3'>Edit Profile</h3>
                  ...
                  <Link to='#' className='btn btn-dark light btn-rounded mr-3 mb-2'>
                    Cancel
                  </Link>
                  <Link className='btn btn-primary btn-rounded mb-2' to='#'>
                    Save Changes
                  </Link>
                </div>
                <div className='card-body'>
                  <form>
                    ...
                    <div className='mb-5'>
                      <div className='title mb-4'>
                        <span className='fs-18 text-black font-w600'>About me</span>
                      </div>
                      <div className='row'>
                        <div className='col-xl-12'>
                          <div className='form-group'>
                    ...
                    <div>
                      <div className='title mb-4'>
                        <span className='fs-18 text-black font-w600'>Skils</span>
                      </div>
                      <div className='row'>
                        <div className='col-xl-6'>
                          <div className='media mb-4'>
                            <span className='text-primary progress-icon mr-3'>78%</span>
                            <div className='media-body'>
                              <p className='font-w500'>Programming</p>
                        ...
                        <div className='col-xl-6'>
                          <div className='media mb-4'>
                            <span className='text-primary progress-icon mr-3'>65%</span>
                            <div className='media-body'>
                              <p className='font-w500'>Prototyping</p>
                              <div className='progress skill-progress' style={{ height: '10px' }}>
                                <div
                                  className='progress-bar bg-primary progress-animated'
                                  style={{
                        ...
                        <div className='col-xl-6'>
                          <div className='media mb-4'>
                            <span className='text-primary progress-icon mr-3'>89%</span>
                            <div className='media-body'>
                              <p className='font-w500'>UI Design</p>
                              <div className='progress skill-progress' style={{ height: '10px' }}>
                                <div
                                  className='progress-bar bg-primary progress-animated'
                                  style={{
                        ...
                        <div className='col-xl-6'>
                          <div className='media mb-4'>
                            <span className='text-primary progress-icon mr-3'>94%</span>
                            <div className='media-body'>
                              <p className='font-w500'>Researching</p>
                              <div className='progress skill-progress' style={{ height: '10px' }}>
                                <div
                                  className='progress-bar bg-primary progress-animated'
                                  style={{
                  ...
                  <div className='row'>
                    <div className='col-6'>
                      <div className='border rounded p-2'>
                        <h4 className='fs-22 text-black font-w600'>228</h4>
                        <span className='text-black'>Following</span>
                      </div>
                    </div>
                    <div className='col-6'>
                      <div className='border rounded p-2'>
                        <h4 className='fs-22 text-black font-w600'>4,842</h4>
              ...
              <div className='card'>
                <div className='card-header border-0 pb-0'>
                  ...
                  <Dropdown className='dropdown float-right custom-dropdown mb-0'>
                    ...
                    <Dropdown.Menu className='dropdown-menu dropdown-menu-right'>
                      <Dropdown.Item className='dropdown-item' to='/profile'>
                        Details
                      </Dropdown.Item>
                      <Dropdown.Item className='dropdown-item text-danger' to='/profile'>
                        Cancel
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>{' '}
                ...
                <div className='card-body'>
                  <div className='d-flex mb-3 align-items-center bg-light rounded'>
                    ...
                    <span className='font-w500'>/davidheree.porto</span>
                  </div>
                  <div className='d-flex mb-3 align-items-center bg-light rounded'>
                    <svg
                      className='mr-3 min-w50'
