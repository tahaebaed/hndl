...
const UiAccordion = () => {
  ...
  const [activeIndicatorInLeftPosition, setActiveIndicatorInLeftPosition] = useState(0);
  ...
  const [activeAccordionActiveHeader, setActiveAccordionActiveHeader] = useState(0);
  const [activeAccordionHeaderShadow, setActiveAccordionHeaderShadow] = useState(0);
  const [activeaccordionRoundedStylish, setActiveaccordionRoundedStylish] = useState(0);
        ...
        <Col xl='6'>
          <Card>
            <Card.Header className='d-block'>
              ...
              <Card.Text className='m-0 subtitle'>
                Accordion with border. Add class <code>accordion-bordered</code> with the class{' '}
                <code> accordion</code>
              </Card.Text>
            </Card.Header>
            <Card.Body>
                ...
                {defaultAccordion.map((data, i) => (
                  <div className='accordion__item' key={i}>
                    <Accordion.Toggle
                      ...
                      as={Card.Text}
                      eventKey={`${i}`}
                      onClick={() => setActiveBordered(activeBordered === i ? -1 : i)}
                    >
                      {' '}
                      <span className='accordion__header--text'>{data.title}</span>
                      <span className='accordion__header--indicator'></span>
                    </Accordion.Toggle>
        ...
        <Col xl='6'>
          <Card>
            <Card.Header className='d-block'>
              ...
              <Card.Text className='m-0 subtitle'>
                Add <code>accordion-no-gutter</code> class with <code>accordion</code>
              </Card.Text>
            </Card.Header>
            <Card.Body>
              <Accordion
                ...
                {defaultAccordion.map((d, i) => (
                  <div className='accordion__item' key={i}>
                    <Accordion.Toggle
                      ...
                      onClick={() => setActiveWithoutSpace(activeWithoutSpace === i ? -1 : i)}
                    >
                      <span className='accordion__header--text'>{d.title}</span>
                      <span className='accordion__header--indicator'></span>
                    </Accordion.Toggle>
                ...
                {defaultAccordion.map((d, i) => (
                  <div className='accordion__item' key={i}>
                    <Accordion.Toggle
                      ...
                      onClick={() =>
                        setActiveWithoutSpaceBordered(activeWithoutSpaceBordered === i ? -1 : i)
                      }
                    >
                      <span className='accordion__header--text'>{d.title}</span>
        ...
        <Col xl='6'>
          <Card>
            <Card.Header className='d-block'>
              ...
              <Card.Text className='m-0 subtitle'>
                Add <code>accordion-left-indicator</code> class with <code>accordion</code>
              </Card.Text>
            </Card.Header>
            <Card.Body>
        ...
        <Col xl='6'>
          <Card>
            <Card.Header className='d-block'>
              ...
              <Card.Text className='m-0 subtitle'>
                Add <code>accordion-with-icon</code> class with <code>accordion</code>
              </Card.Text>
            </Card.Header>
            <Card.Body>
                ...
                {defaultAccordion.map((d, i) => (
                  <div className='accordion__item' key={i}>
                    <Accordion.Toggle
                      ...
                      onClick={() =>
                        setActiveAccordionWithIcon(activeAccordionWithIcon === i ? -1 : i)
                      }
                    >
        ...
        <Col xl='6'>
          <Card>
            <Card.Header className='d-block'>
              ...
              <Card.Text className='m-0 subtitle'>
                Add <code>accordion-header-bg</code> class with <code>accordion</code>
              </Card.Text>
            </Card.Header>
            <Card.Body>
              <Accordion className='accordion accordion-header-bg ' defaultActiveKey='0'>
                {defaultAccordion.map((d, i) => (
                  <div className='accordion__item' key={i}>
                    <Accordion.Toggle
                      as={Card.Text}
                      ...
                      onClick={() =>
                        setActiveAccordionHeaderBg(activeAccordionHeaderBg === i ? -1 : i)
                      }
                    >
                      <span className='accordion__header--icon'></span>
                      <span className='accordion__header--text'>{d.title}</span>
        ...
        <Col xl='6'>
          <Card>
            <Card.Header className='d-block'>
              ...
              <Card.Text className='m-0 subtitle'>
                Add <code>accordion-solid-bg</code> class with <code>accordion</code>
              </Card.Text>
            </Card.Header>
            <Card.Body>
                ...
                {defaultAccordion.map((d, i) => (
                  <div className='accordion__item' key={i}>
                    <Accordion.Toggle
                      ...
                      onClick={() =>
                        setActiveAccordionSolidBg(activeAccordionSolidBg === i ? -1 : i)
                      }
                    >
                      <span className='accordion__header--icon'></span>
                      <span className='accordion__header--text'>{d.title}</span>
        ...
        <Col xl='6'>
          <Card>
            <Card.Header className='d-block'>
              ...
              <Card.Text className='m-0 subtitle'>
                Add <code>accordion-active-header</code> class with <code>accordion</code>
              </Card.Text>
            </Card.Header>
            <Card.Body>
                ...
                {defaultAccordion.map((d, i) => (
                  <div className='accordion__item' key={i}>
                    <Accordion.Toggle
                      ...
                      onClick={() =>
                        setActiveAccordionActiveHeader(activeAccordionActiveHeader === i ? -1 : i)
                      }
                    >
                      <span className='accordion__header--icon'></span>
                      <span className='accordion__header--text'>{d.title}</span>
        ...
        <Col xl='6'>
          <Card className='transparent-card'>
            <Card.Header className='d-block'>
              ...
              <Card.Text className='m-0 subtitle'>
                Add <code>accordion-header-shadow</code> and <code>accordion-rounded</code> class
                ...
                {defaultAccordion.map((d, i) => (
                  <div className='accordion__item' key={i}>
                    <Accordion.Toggle
                      ...
                      onClick={() =>
                        setActiveAccordionHeaderShadow(activeAccordionHeaderShadow === i ? -1 : i)
                      }
                    >
                      <span className='accordion__header--icon'></span>
                      <span className='accordion__header--text'>{d.title}</span>
        ...
        <Col xl='6'>
          <Card>
            <Card.Header className='d-block'>
              ...
              <Card.Text className='m-0 subtitle'>
                Add <code>accordion-rounded-stylish</code> class with <code>accordion</code>
              </Card.Text>
            </Card.Header>
            <Card.Body>
              <Accordion
        ...
        <Col xl='6'>
          <Card>
            <Card.Header className='d-block'>
              ...
              <Card.Text className='m-0 subtitle'>
                Add <code>accordion-gradient</code> class with <code>accordion</code>
              </Card.Text>
            </Card.Header>
            <Card.Body>
              <Accordion
                ...
                {defaultAccordion.map((d, i) => (
                  <div className='accordion__item' key={i}>
                    <Accordion.Toggle
                      ...
                      onClick={() =>
                        setActiveAccordionGradient(activeAccordionGradient === i ? -1 : i)
                      }
                    >
                      <span className='accordion__header--icon'></span>
                      <span className='accordion__header--text'>{d.title}</span>
