                  ...
                  {listItem.map((list, i) => (
                    <Fragment key={i}>
                      {i === 0 ? (
                        ...
                        <ListGroup.Item action as='a' className='list-group-item-action disabled'>
                          {list}
                        </ListGroup.Item>
                      ) : (
        ...
        <Col xl='6'>
          <Card>
            ...
            <Card.Body>
              <div className='basic-list-group'>
                <ListGroup>
                  <ListGroup.Item as='a' action active className='flex-column align-items-start'>
                    <div className='d-flex w-100 justify-content-between'>
                      <h5 className='mb-3 text-white'>List group item heading</h5>
                  ...
                  <ListGroup.Item as='a' action className='flex-column'>
                    <div className='d-flex w-100 justify-content-between'>
                  ...
                  <ListGroup.Item as='a' action className='flex-column align-items-start'>
                    <div className='d-flex w-100 justify-content-between'>
                      <h5 className='mb-3'>List group item heading</h5>
                      <small className='text-muted'>3 days ago</small>
                    </div>
