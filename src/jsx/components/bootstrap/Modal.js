          ...
          <Card>
            ...
            <Card.Body>
              <Card.Text className='mb-4'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. A, minima! Eligendi minima
                illum itaque harum aliquam vel, sunt magni dolorem! Cum quaerat est cupiditate saepe
                quidem, fugiat in at magni ad provident distinctio eum tempore laboriosam adipisci,
                tempora cumque ex quis unde voluptatem consequuntur. Excepturi quibusdam accusamus
                deleniti officiis ullam repellendus magni unde? Saepe quibusdam vel, ipsum numquam
                ratione tempore. Dolor optio aliquid in velit eaque, sed delectus reprehenderit quam
                quidem a eum id nostrum ullam obcaecati error deleniti modi quasi harum possimus
                voluptatum repellat saepe! Omnis dolor maiores eaque deserunt exercitationem
              ...
              <div className='bootstrap-modal'>
                ...
                {/* <!-- Large modal --> */}
                <Button variant='primary' className='mb-2 mr-2' onClick={() => setLargeModal(true)}>
                  Large modal
                </Button>
                ...
                {/* <!-- Small modal --> */}
                <Button variant='primary' className='mb-2 mr-2' onClick={() => setSmallModal(true)}>
                  Small modal
                </Button>
