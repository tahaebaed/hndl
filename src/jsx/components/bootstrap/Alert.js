      ...
      <Row>
          ...
          <Card>
            ...
            <Card.Body>
              {basicData.map((data, i) => (
                <Alert key={i} variant={data.variant} className='alert-dismissible fade show'>
                  {data.emoji}
          ...
          <Card>
            ...
            <Card.Body>
              {solidColor.map((data, i) => (
                <Alert key={i} variant={data.variant} className='solid alert-dismissible fade show'>
                  <strong>{data.msg}</strong> {data.text}
        ...
        <Col xl={6} className='col-xxl-12'>
          <Card>
            ...
            <Card.Body>
              {square.map((data, i) => (
                <Alert key={i} variant={data.variant} className='solid alert-square'>
                  <strong>{data.msg}</strong> {data.text}
                </Alert>
              ))}
            </Card.Body>
        ...
        <Col xl={6} className='col-xxl-12'>
          <Card>
            ...
            <Card.Body>
              {rounded.map((data, i) => (
                <Alert key={i} variant={data.variant} className='solid alert-rounded'>
                  <strong>{data.msg}</strong> {data.text}
                </Alert>
              ))}
            </Card.Body>
          ...
          <Card>
            ...
            <Card.Body>
              {withLinkAndSolidColor.map((data, i) => (
                <Alert key={i} variant={data.variant} className='alert-dismissible solid fade show'>
                  <strong>{alertDefferentMsg(data)}</strong>{' '}
                  <Badge variant={data.variant} as='a' href='#' className='badge-sm light ml-1'>
                    upgrade
                  </Badge>
            ...
            <Card.Body>
              <Row>
                {inlineNotifications.map((data, i) => (
                  <Col xl={6} key={i}>
                    <Alert variant={data.variant} className='alert alert-primary notification'>
                      ...
                      <p>
                        ...
                        stage-at lease it seems that way.
                      </p>
        ...
        <div className='col-xl-12 col-xxl-12'>
          <Card>
            <Card.Header className='d-block'>
              ...
              <p className='mb-0 subtitle'>
                add <code>.alert-social .facebook,.twitter,.linkedin,.google-plus</code> to change
                the style
              </p>
            </Card.Header>
            <Card.Body>
            ...
            <Card.Body>
              <Row>
                {messageAlertWithSolidColor.map((data, i) => (
                  <Col xl={6} key={i}>
                    <Alert variant={data.variant} className='alert-dismissible solid'>
            ...
            <Card.Body>
              <Row>
                {leftIconBig.map((data, i) => (
                  <Col xl={6} key={i}>
                    <Alert variant={data.variant} className='alert-dismissible left-icon-big'>
