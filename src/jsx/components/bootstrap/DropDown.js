              ...
              <div className='basic-dropdown'>
                <Dropdown>
                  ...
                  <Dropdown.Menu>
                    ...
                    <Dropdown.Item to={'#'}>Another link</Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
              </div>
            </Card.Body>
          ...
          <Card>
            <Card.Header className='d-block'>
              ...
              <Card.Text className='m-0 subtitle'>
                ...
                <code>.dropdown-menu-right</code> class to the element with .dropdown-menu
              </Card.Text>
            </Card.Header>
            <Card.Body>
              <div className='basic-dropdown'>
            ...
            <Card.Body>
              <div className='dropdown-size'>
                ...
                >
                  ...
                  <div className='dropdown-divider'></div>
                  <Dropdown.Item to={'#'}>Separated link</Dropdown.Item>
                </DropdownButton>
              ...
              <Row>
                <Col xl={3}>
                  <Dropdown>
                    ...
                    <Dropdown.Menu>
                      <Dropdown.Item to={'#'}>Last 1 Month</Dropdown.Item>
                      <Dropdown.Item to={'#'}>Last 6 Month</Dropdown.Item>
                      <Dropdown.Item to={'#'}>Last 10 Month</Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                </Col>
                ...
                <Col xl={3}>
                  <Dropdown>
                    <Dropdown.Toggle variant='outline-primary' size='sm' className='mb-1'>
                      Last 7 days
                    </Dropdown.Toggle>
                    <Dropdown.Menu>
                      <Dropdown.Item to={'#'}>Last 1 Month</Dropdown.Item>
                ...
                <Col xl={3}>
                  <Dropdown>
                    ...
                    <Dropdown.Menu>
                      <Dropdown.Item to={'#'}>Last 1 hour</Dropdown.Item>
                      <Dropdown.Item to={'#'}>Last 2 hour</Dropdown.Item>
                      <Dropdown.Item to={'#'}>Last 3 hour</Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                </Col>
                ...
                <Col xl={3}>
                  <Dropdown>
                    <Dropdown.Toggle variant='primary' size='sm' id='whiteSpace' className='mb-1'>
                ...
                <Col xl={3}>
                  <Dropdown>
                    ...
                    <Dropdown.Menu>
                      <Dropdown.Item to={'#'}>Option 1</Dropdown.Item>
                      <Dropdown.Item to={'#'}>Option 2</Dropdown.Item>
                      <Dropdown.Item to={'#'}>Option 3</Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                </Col>
