        ...
        <div className='col-xl-6'>
          <div className='card'>
            <div className='card-body'>
              ...
              <CustomClearIndicator></CustomClearIndicator>
              <br />
              <button type='button' className='btn btn-primary mr-2' id='js-programmatic-enable'>
                Enable
              </button>
              <button type='button' className='btn btn-primary' id='js-programmatic-disable'>
                Disable
              </button>
            </div>
          </div>
          ...
          <div className='card'>
            <div className='card-body'>
              <div className='mb-4'>
                ...
                <p>
                  Select2 comes with AJAX support built in, using jQuery's AJAX methods. In this
        ...
        <div className='col-xl-4'>
          <div className='card'>
            <div className='card-body'>
              ...
              <button type='button' id='destroy-selector-trigger' className='btn btn-primary'>
                Destroy Select2
              </button>
            </div>
          </div>
        ...
        <div className='col-xl-4'>
          <div className='card'>
            <div className='card-body'>
              ...
              <button type='button' id='dropdown-trigger-open' className='btn btn-primary'>
                Open Dropdown
              </button>
            </div>
          </div>
        ...
        <div className='col-xl-4'>
          <div className='card'>
            <div className='card-body'>
              ...
              <button type='button' id='closing-dropdown-trigger' className='btn btn-primary mb-2'>
                Close Dropdown
              </button>
              <div className='mt-4'>
                <Select
        ...
        <div className='col-xl-6'>
          <div className='card'>
            <div className='card-body'>
              ...
              <button type='button' className='js-programmatic-open btn btn-primary mb-2 mr-1'>
                Open
              </button>
              <button type='button' className='js-programmatic-close btn btn-primary mb-2 mr-1'>
                Close
              </button>
              <button type='button' className='js-programmatic-destroy btn btn-primary mb-2 mr-1'>
                Destroy
              </button>
              <button type='button' className='js-programmatic-init btn btn-primary mb-2 mr-1'>
                Re-initialize
              </button>
              <div className='mt-4'>
                <CustomSelete />
        ...
        <div className='col-xl-6'>
          <div className='card'>
            <div className='card-body'>
              ...
              <button
                type='button'
                className='js-programmatic-multi-clear btn btn-primary mb-2 mr-1'
              >
                Clear
              </button>
              <div className='mt-4'>
