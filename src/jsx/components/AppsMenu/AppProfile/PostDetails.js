              ...
              <div className='card-body'>
                <div className='post-details'>
                  ...
                  <blockquote>
                    ...
                    been the industry's standard text ever since the 1500s, when an unknown printer
                  ...
                  <div className='profile-skills mt-5 mb-5'>
                    ...
                    <Link to='/post-details' className='btn btn-primary light btn-xs mb-1 mr-1'>
                      Admin
                    </Link>
                    <Link to='/post-details' className='btn btn-primary light btn-xs mb-1 mr-1'>
                      Dashboard
                  ...
                  <div className='comment-respond' id='respond'>
                    <h4 className='comment-reply-title text-primary mb-3' id='reply-title'>
                      Leave a Reply{' '}
                    </h4>
                    <form
