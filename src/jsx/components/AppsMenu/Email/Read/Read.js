        ...
        <div className='col-lg-12'>
          <div className='card'>
            <div className='card-body'>
              <div className='email-left-box generic-width px-0 mb-3'>
                <div className='p-0'>
                  <Link to='/email-read' className='btn btn-primary btn-block'>
                    Compose
                  </Link>
                </div>
                <div className='mail-list mt-4'>
                  <Link to='/email-read' className='list-group-item active'>
                    <i className='fa fa-inbox font-18 align-middle mr-2'></i>
                    Inbox
                    <span className='badge badge-primary badge-sm float-right'>198</span>
                  </Link>
                  ...
                  <Link to='/email-read' className='list-group-item'>
                    ...
                    Important
                    <span className='badge badge-danger badge-sm text-white float-right'>47</span>
                  </Link>
                  <Link to='/email-read' className='list-group-item'>
                      ...
                      <div className='toolbar mb-4' role='toolbar'>
                        ...
                        <Dropdown className='btn-group mb-1  mr-1'>
                          ...
                          <Dropdown.Menu className='dropdown-menu'>
                            <Dropdown.Item as='a' className='dropdown-item' to='/email-read'>
                              Social
                            </Dropdown.Item>
                            <Dropdown.Item as='a' className='dropdown-item' to='/email-read'>
                              Promotions
                        ...
                        <Dropdown className='btn-group mb-1 mr-1'>
                          ...
                          <Dropdown.Menu className='dropdown-menu'>
                            <Dropdown.Item className='dropdown-item' to='/email-read'>
                              Mark as Unread
                            </Dropdown.Item>
                            <Dropdown.Item className='dropdown-item' to='/email-read'>
                              Add to Tasks
                      ...
                      <div className='read-content'>
                        <div className='media pt-3 d-sm-flex d-block justify-content-between'>
                          <div className='clearfix mb-3 d-flex'>
                            <img className='mr-2 rounded' width='50' alt='' src={profileImage} />
                          ...
                          <div className='clearfix mb-3'>
                            <Link to='/email-read' className='btn btn-primary px-3 light'>
                              <i className='fa fa-reply'></i>
                            </Link>
                            <Link to='/email-read' className='btn btn-primary px-3 light ml-2'>
                        ...
                        <div className='read-content-body'>
                          ...
                          <p className='mb-2'>
                            <strong>Ingredia Nutrisha,</strong> A collection of textile samples lay
                            spread out on the table - Samsa was a travelling salesman - and above it
