              ...
              <Table responsive>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <Dropdown>
                        <Dropdown.Toggle variant='success' className='light sharp icon-false'>
                          {svg1}
                        </Dropdown.Toggle>
                        <Dropdown.Menu>
                  ...
                  <tr>
                    ...
                    <td>
                      <Dropdown>
                        <Dropdown.Toggle variant='danger' className='light sharp icon-false'>
                          {svg1}
                        </Dropdown.Toggle>
                        <Dropdown.Menu>
                          <Dropdown.Item>Edit</Dropdown.Item>
                  ...
                  <tr>
                    ...
                    <td>
                      <Dropdown>
                        <Dropdown.Toggle variant='warning' className='light sharp icon-false'>
                          {svg1}
                        </Dropdown.Toggle>
                        <Dropdown.Menu>
                          <Dropdown.Item>Edit</Dropdown.Item>
              ...
              <Table responsive>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div className='d-flex align-items-center'>
                        <img src={avatar1} className='rounded-lg mr-2' width='24' alt='' />{' '}
                    ...
                    <td>
                      <div className='d-flex align-items-center'>
                        <i className='fa fa-circle text-success mr-1'></i> Successful
                      </div>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className='d-flex align-items-center'>
                        <img src={avatar2} className='rounded-lg mr-2' width='24' alt='' />{' '}
                        <span className='w-space-no'>Dr. Jackson</span>
                      </div>
                    </td>
                    <td>example@example.com </td>
                    ...
                    <td>
                      <div className='d-flex align-items-center'>
                        <i className='fa fa-circle text-danger mr-1'></i> Canceled
                      </div>
                    </td>
                    <td>
                      <div className='d-flex'>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className='d-flex align-items-center'>
                        <img src={avatar3} className='rounded-lg mr-2' width='24' alt='' />{' '}
                        <span className='w-space-no'>Dr. Jackson</span>
                      </div>
                    </td>
                    <td>example@example.com </td>
                    ...
                    <td>
                      <div className='d-flex align-items-center'>
                        <i className='fa fa-circle text-warning mr-1'></i> Pending
                      </div>
                    </td>
                    <td>
                      <div className='d-flex'>
              ...
              <Table responsive bordered className='verticle-middle'>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span>
                        <Link to={'#'} className='mr-4' title='Edit'>
