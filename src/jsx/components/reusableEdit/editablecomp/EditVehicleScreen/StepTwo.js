...
const StepTwo = ({ activeStep, setActiveStep, register, setChecked, checked, serviceProgList, watch, setValue }) => {
  ...
  return (
    <div>
      <div className='maintenance-radio'>
        <div>
          <h4>Add vehicle Without service Program</h4>
          <label
          ...
          >
            <div className='d-flex align-items-center'>
              <input type='radio' id='service-program' className='mr-2' checked={!checked} />
              None
            </div>
        ...
        <div>
          <h4>Choose a Service Program</h4>
          <label
          ...
          >
            <input type='radio' value={selectValue} checked={checked} id='vehicle-name' />
            <select
              disabled={!checked}
              defaultValue={watch('vehicle.maintenance.serviceProgram') ?? selectValue}
